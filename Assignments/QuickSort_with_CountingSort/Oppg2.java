...
public class Oppg2 {
        ...
        for(int a = 0; a<antKjoringer; a++){
            ...
            switch (listetype){
                ...
                case "UNIKE_TALL":
                    ...
                    break;
                case "SORTERT":
                    liste = genererSortertListe(storrelse);
                    break;
                default:
     ...
     * @return den genererte listen
     */
    private static int[] genererSortertListe(int storrelse){
    ...
    private static void quickSortMedCountingSort(int[] liste, int venstreEndepunkt, int hoyreEndepunkt) {
        ...
        if(venstreEndepunkt < hoyreEndepunkt ){
            int storste = liste[hoyreEndepunkt];
            ...
            if (kjor && storste - minste < hoyreEndepunkt - venstreEndepunkt){
    ...
    private static int splitt(int[] liste, int venstreEndepunkt, int hoyreEndepunkt) {
        ...
        bytt(liste, hoyreEndepunkt , Math.round(venstreEndepunkt+hoyreEndepunkt)/2);
